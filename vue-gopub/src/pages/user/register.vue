      ...
      <div class="login-forma">
        <el-form ref="form" :model="form" :rules="rules" label-width="0">
          ...
          <el-form-item v-if="form.Role==20" label="项目名称:" label-width="100px">
            <el-select v-model="pro_id" filterable placeholder="请选择" multiple>
              <el-option
...
import { portUser, portConf } from "common/port_uri";
...
export default {
  ...
  methods: {
    ...
    submit_forma() {
      ...
      this.$http
        .post(portUser.register + "?id=" + this.userId, this.form)
        .then(({ data: { msg } }) => {
          this.$message({
            message: msg,
            type: "success"
