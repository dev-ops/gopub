...
192.168.0.2:21"
                    ...
                    <el-form-item v-if="form.IsGroup" label="机器列表:" prop="Hosts">
                      <div>
                        <el-button type="primary" icon="plus" @click="add_data()">添加</el-button>
                      </div>
                      <ul>
...
192.168.0.2:21"
                          ...
                          <el-button type="danger" icon="delete" @click="delete_data(key)">删除</el-button>
                        </li>
                      </ul>
                  ...
                  <div class="panel-body el-form el-form--label-top">
                    <el-form-item label="代码检出前任务:" prop="PreDeploy">
                      <el-tooltip
                        ...
                        placement="top"
                      >
                        <el-input v-model="form.PreDeploy" type="textarea" autosize/>
                      </el-tooltip>
                    </el-form-item>
                    <el-form-item label="代码检出后任务:" prop="PostDeploy">
                      <el-tooltip
                        ...
                        placement="top"
                      >
                        <el-input v-model="form.PostDeploy" type="textarea" autosize/>
                      </el-tooltip>
                    </el-form-item>
                    <el-form-item label="同步完目标机后任务:" prop="PreRelease">
                      <el-tooltip
                        ...
                        placement="top"
                      >
                        <el-input v-model="form.PreRelease" type="textarea" autosize/>
                      </el-tooltip>
                    </el-form-item>
                    <el-form-item label="更改版本软链接后任务:" prop="PostRelease">
                      <el-tooltip
                        ...
                        placement="top"
                      >
                        <el-input v-model="form.PostRelease" type="textarea" autosize/>
                      </el-tooltip>
                    </el-form-item>
                    <el-form-item label="版本发布发布完成后执行本地任务:" prop="LastDeploy">
                      <el-tooltip
                        ...
                        placement="top"
                      >
                        <el-input v-model="form.LastDeploy" type="textarea" autosize/>
                      </el-tooltip>
                    </el-form-item>
                  </div>
                </div>
      ...
      this.$http
        ...
        .then(({ data: { data } }) => {
          ...
          if (this.form.IsGroup) {
            let shosts = this.form.Hosts.split("\n");
            for (let i in shosts) {
              let count = shosts[i].split("#");
              if (count.length == 2) {
    ...
    on_submit_form() {
      this.$refs.form.validate(valid => {
        ...
        if (this.form.IsGroup) {
          ...
          for (let i in this.hosts) {
            let count = (i | 0) + 1;
            let shosts = this.hosts[i].split("\n");
            for (let j = 0; j < shosts.length; j++) {
              shosts[j] = shosts[j].replace(/\r|\n/g, "");
